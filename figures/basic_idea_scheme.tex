...
\tikzstyle{practica} = [materia,text width = 10em, minimum height=3em, rounded corners]
...
\begin{tikzpicture}[scale=0.7,transform shape]
  ...
  \path (p2.south)+(-2.5,-1.5) node (p3) [practica] {Constraint Equations};
  \path (p2.south)+(2.5,-1.5) node (p4) [practica] {Evolution Equations};
  ...
  \path (p6.south)+(2.5,-1.5) node (p7) [practica] {Choosing Coordinates};
  ...
  % \path (p14.south)+(-2.5,-1.5) node (p15) [practica] {Conmutaci\'on telef\'onica};
  ...
  \path [line] (p6.south) -- +(0.0,-0.5) -- +(2.5,-0.5) -- node [above,midway] {} (p7) ;
